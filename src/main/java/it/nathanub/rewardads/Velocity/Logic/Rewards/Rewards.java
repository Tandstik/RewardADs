package it.nathanub.rewardads.Velocity.Logic.Rewards;
...
public class Rewards {
    ...
    public Rewards(VelocityMain plugin) {
    ...
    public String getList() throws ExecutionException, InterruptedException {
        ...
        if (response != null) {
            JsonElement jsonElement = (JsonElement)this.gson.fromJson(response, JsonElement.class);
