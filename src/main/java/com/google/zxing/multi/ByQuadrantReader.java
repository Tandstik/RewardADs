...
/**
 * This class attempts to decode a barcode from an image by scanning the four quadrants and the center.
 * This helps when multiple barcodes are present and scanning the whole image might fail.
 *
...
public final class ByQuadrantReader implements Reader {
  ...
  public Result decode(BinaryBitmap image, Map<DecodeHintType,?> hints)
    ...
    try {
      ...
      // No barcode found in any quadrant or center
